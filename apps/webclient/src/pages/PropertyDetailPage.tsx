...
import { PropertyDetailsSection } from '../features/explore/components/PropertyDetailsSection';
import { PrioritizationResultsSection } from '../features/explore/components/PrioritizationResultsSection';
import { ExploreActions } from '../features/explore/components/ExploreActions';
import { IndustrialCitiesService } from '../features/explore/services/industrialCitiesService';
import { ApiDownNotice } from '../features/explore/components/ApiDownNotice';
...
async function fetchIndustrialCityById(
  ...
  try {
    ...
    const industrialCity: IIndustrialCityModel = {
      ...
      electricity: foundProperty.electricity,
      water: foundProperty.water,
      gas: foundProperty.gas,
      landsAndFactories: {
...
export function PropertyDetailPage({ params }: PageProps) {
