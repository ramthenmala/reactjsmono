    ...
    it('should handle empty response data with fallback defaults', async () => {
      ...
      expect(result).toEqual({
        ...
        prioritizationResultInfo: {
          ...
          socialAndCommunity: {
            title: '',
            residentialAreas: { status: false, title: '', value: null },
            hospitalsAndMedicalCenters: { status: false, title: '', value: null },
            publicTransportationAvailability: { status: false, title: '', value: null },
            educationalInstitutions: { status: false, title: '', value: null },
            noOfBanksAndCreditInstitutions: { status: false, title: '', value: null },
            amenitiesForWorkforce: { status: false, title: '', value: null },
            scenicLocationAndSurroundings: { status: false, title: '', value: null },
          },
          marketAccessAndDemand: { title: '', subTitle: '', value: null, image: null },
          leagalAndRegulatory: { title: '', subTitle: '', value: null, image: null },
          environmental: {
            title: '',
            image: null,
