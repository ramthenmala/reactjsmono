export const exploreActionsStyles = {
  ...
  button: {
    common: "relative overflow-hidden rounded-xl backdrop-blur-xl px-3 py-2 text-white shadow-md before:absolute before:inset-0 before:rounded-xl before:border before:border-white/80 before:opacity-50 before:content-[''] before:pointer-events-none before:z-0",
    variants: {
      dark: "bg-black/50",
      light: "bg-white/50"
    },
