...
export function useInvestorJourney(steps?: InvestorJourneyCard[]) {
    ...
    () => [
      {
        ...
        content:
          t('investor_journey.search.description') ||
          'Use our advanced search to find industrial opportunities that match your criteria',
      },
      {
        icon: '/assets/images/icons/compare-icon.svg',
        title: t('investor_journey.compare.title') || 'Compare Options',
        content:
          t('investor_journey.compare.description') ||
          'Analyze different locations and properties with detailed insights and data',
      },
      {
        icon: '/assets/images/icons/visit-icon.svg',
        title: t('investor_journey.visit.title') || 'Schedule Visits',
        content:
          t('investor_journey.visit.description') ||
          'Arrange site visits and meetings with relevant stakeholders',
      },
      {
        icon: '/assets/images/icons/invest-icon.svg',
        title: t('investor_journey.invest.title') || 'Make Investment',
        content:
          t('investor_journey.invest.description') ||
  ...
  const content = {
    ...
    defaultContent:
      t('investor_journey.subtitle') ||
      'Follow our streamlined process to secure your industrial investment',
    ctaTitle:
      t('investor_journey.cta.title') ||
      'Ready to Start Your Investment Journey?',
    ctaDescription:
      t('investor_journey.cta.description') ||
      'Join hundreds of successful investors who have found their perfect industrial investment opportunity through our platform.',
