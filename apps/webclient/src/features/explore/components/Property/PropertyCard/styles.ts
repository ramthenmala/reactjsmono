...
export const propertyCardStyles = {
  ...
  imageOverlay:
    'absolute inset-0 bg-gradient-to-t from-black/30 to-transparent rounded-t-2xl',
  featuredBadge: 'absolute top-3 left-3 z-10',
  featuredButton:
    'rounded-[12px] bg-[rgba(0,0,0,0.60)] px-3 py-1.5 text-white shadow-md relative overflow-hidden min-h-0 pointer-events-none border-0',
  ...
  locationText:
    'font-medium text-sm leading-5 tracking-normal flex items-center gap-1 text-[#171B23]',

  metricsContainer: 'text-sm w-full',
  metricRow: 'flex items-center justify-between py-2',
  metricLabel:
    'flex items-center gap-2 font-medium text-sm leading-5 tracking-normal',
  ...
  distanceCard:
    'flex items-center justify-center gap-2 bg-[#F3F4F6] rounded-xl h-[52px] px-4 font-medium text-sm leading-5 tracking-normal text-[#171B23]',
