  ...
  return (
    <div className={mapStyles.backButton.container}>
      <button
        ...
        className={mapStyles.backButton.button}
      >
        <svg width={mapStyles.icons.back.width} height={mapStyles.icons.back.height} viewBox={mapStyles.icons.back.viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
