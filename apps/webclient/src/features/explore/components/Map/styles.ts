...
export const mapStyles = {
  ...
  container: {
    ...
    errorContainer: (className: string) => `${className} bg-gray-100 flex items-center justify-center rounded-xl`,
  ...
  controls: {
    ...
    layerButton: "bg-white p-2 rounded-lg shadow-lg hover:bg-gray-50 transition-colors flex items-center",
    layerDropdown: {
      container: "absolute top-full right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-20",
  ...
  backButton: {
    ...
    button: "bg-white px-4 py-2 rounded-lg shadow-lg hover:bg-gray-50 transition-colors flex items-center gap-2 cursor-pointer"
  },
  ...
  popup: {
    ...
    closeButton: "absolute top-3 right-3 z-50 w-8 h-8 bg-black/60 text-white rounded-full flex items-center justify-center text-lg font-bold hover:bg-black/80 transition-all cursor-pointer shadow-md"
  },
