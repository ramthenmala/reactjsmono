  ...
  return (
    <div className={mapStyles.controls.container}>
      ...
      <div className="relative">
        ...
        >
          <svg width={mapStyles.icons.layers.width} height={mapStyles.icons.layers.height} viewBox={mapStyles.icons.layers.viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {showLayerMenu && (
          <div className={mapStyles.controls.layerDropdown.container}>
            <button
              ...
              className={mapStyles.controls.layerDropdown.button(activeMapStyle === 'streets')}
            >
              <svg width={mapStyles.icons.streetView.width} height={mapStyles.icons.streetView.height} viewBox={mapStyles.icons.streetView.viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className={mapStyles.controls.layerDropdown.label}>Streets</span>
            </button>
            ...
            <button
              ...
              className={mapStyles.controls.layerDropdown.button(activeMapStyle === 'satellite')}
            >
              <svg width={mapStyles.icons.satelliteView.width} height={mapStyles.icons.satelliteView.height} viewBox={mapStyles.icons.satelliteView.viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="10" cy="10" r="7" fill="currentColor" opacity="0.3"/>
                <circle cx="10" cy="10" r="3" fill="currentColor" opacity="0.6"/>
              </svg>
              <span className={mapStyles.controls.layerDropdown.label}>Satellite</span>
            </button>
          </div>
        )}
      </div>
      ...
      <ButtonGroup size="sm" className={mapStyles.controls.zoomGroup}>
        <ButtonGroupItem id="zoom-in" onClick={onZoomIn}>
          <svg width={mapStyles.icons.zoom.width} height={mapStyles.icons.zoom.height} viewBox={mapStyles.icons.zoom.viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
