...
describe('useScrollSpy', () => {
  beforeEach(() => {
    ...
    jest.spyOn(document, 'getElementById').mockReturnValue(mockElement as HTMLElement | null);
  ...
  it('handles initial hash navigation', () => {
    mockUseLocation.mockReturnValue({ pathname: '/analytics', hash: '#national' });
  ...
  it('sets active section from hash', () => {
    mockUseLocation.mockReturnValue({ pathname: '/analytics', hash: '#sectoral' });
  ...
  it('handles missing element in hash navigation', () => {
    mockUseLocation.mockReturnValue({ pathname: '/analytics', hash: '#nonexistent' });
  ...
  it('does not navigate when URLs are the same', () => {
    mockFindActiveSection.mockReturnValue('national');
    mockCreateUrlForSection.mockReturnValue('/en/analytics#national');
    mockUseLocation.mockReturnValue({ pathname: '/en/analytics', hash: '#national' });
  ...
  it('handles existing timeout clearance in hash navigation', () => {
    ...
    jest.spyOn(global, 'setTimeout').mockReturnValue(mockTimeoutId as NodeJS.Timeout);
